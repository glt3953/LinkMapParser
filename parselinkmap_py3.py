        ...
        for base_bundle_map in base_bundle_list:
            ...
            if base_name == target_name:
                ...
                if base_size_value < target_size_value:
                    print("%s%s%s" % (target_name.ljust(50), str("%.2fM" % base_size_value).ljust(10), str("%.2fM" % target_size_value).ljust(10)))
                    pass
                break
            pass
        if has_bundle_in_base == 0:
            print("%s%s%s%s" % (target_name.ljust(50), str("%.2fM" % base_size_value).ljust(10), str("%.2fM" % target_size_value).ljust(10), "Y".center(10)))
            pass
        pass
